...
public class GlUtil {
    ...
    public static int createProgram(String vertexSource, String fragmentSource) {
        ...
        LogUtils.iTag(TAG, "linkStatus:" + linkStatus[0]);
        return program;
    }
    ...
    public static byte[] readBufferFromTexture(int textureId, int width, int height) {
        Log.d("GreenSeg", "getBitmapByTextureId() called with: textureId = [" + textureId + "], width = [" + width + "], height = [" + height + "]");
        ...
        GLES20.glFramebufferTexture2D(GLES20.GL_FRAMEBUFFER, GLES20.GL_COLOR_ATTACHMENT0, GL_TEXTURE_EXTERNAL_OES, textureId, 0);
        long startglReadPixelsTime = System.currentTimeMillis();
        GLES20.glReadPixels(0, 0, width, height, GLES20.GL_RGBA, GLES20.GL_UNSIGNED_BYTE, tmpBuffer);
        LogUtils.i(TAG, "glReadPixels cost time:" + (System.currentTimeMillis() - startglReadPixelsTime));
