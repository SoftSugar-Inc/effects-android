package softsugar.senseme.com.effects.encoder.utils;
...
public final class RenderHandler implements Runnable {
	...
	public final void setEglContext(final EGLContext shared_context, final int tex_id, final Object surface, final boolean isRecordable) {
		if (DEBUG) LogUtils.iTag(TAG, "setEglContext:");
...
//********************************************************************************
	...
	public final void run() {
		if (DEBUG) LogUtils.iTag(TAG, "RenderHandler thread started:");
		synchronized (mSync) {
...
//					mSync.notifyAll();
		...
		if (DEBUG) LogUtils.iTag(TAG, "RenderHandler thread finished:");
	}

	private final void internalPrepare() {
		if (DEBUG) LogUtils.iTag(TAG, "internalPrepare:");
		internalRelease();
	...
	private final void internalRelease() {
		if (DEBUG) LogUtils.iTag(TAG, "internalRelease:");
