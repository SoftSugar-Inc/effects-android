...
//                attrib_list);
        mEGLContext = ContextHolder.getEGLContext();
...
//        mDrawer = null;
    ...
    public void makeCurrent() {
        LogUtils.iTag(TAG, "makeCurrent() called" + !mEGL.eglMakeCurrent(mEGLDisplay, mEGLSurface, mEGLSurface, mEGLContext));
        if (mEGL == null) {
...
//        mDrawer.onDrawFrame(null);
    ...
    public void onFrameAvailable(SurfaceTexture st) {
        ...
        if (VERBOSE) LogUtils.iTag(TAG, "new frame available");
        synchronized (mFrameSyncObject) {
            if (mFrameAvailable) {
    ...
    public void setCurrentStickerPath(LinkedHashMap<Integer, String> map){
        ...
        mTextureRender.setCurrentStickerPath(map);
    }
    ...
    public void setGreenParamsMap(HashMap<Integer, Float> map){
        ...
        mTextureRender.setGreenParamsMap(map);
    }
